...
export const commands: Command[] = [
  ...
  {
    id: "window.toggle_fullscreen",
    label: "Toggle Full Screen",
    description: "Enter or exit full screen mode",
    category: "View",
    action: "window.toggle_fullscreen",
    keywords: ["fullscreen", "full", "screen", "maximize"],
    keybinding: "Cmd+Enter",
  },
  {
    id: "window.toggle_always_on_top",
    label: "Toggle Always on Top",
    description: "Keep window always on top of other windows",
    category: "View",
    action: "window.toggle_always_on_top",
    keywords: ["always", "on", "top", "float", "pin"],
  },
  {
    id: "command_palette.open_fs",
    label: "Go to File",
